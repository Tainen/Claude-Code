...
- No.004（Doc 名は No.001_…）で先行適用。旧 Doc は `_old_v4_装飾なし_`。他17本への展開は堀本さんがサンプルを確認してから。**要確認**：No.008（部活動連携イベントの記事）と SKILL.md の「1回15万〜40万円（税抜）・追加料金なし」は HP 確定版の数字だが、「成果報酬」の説明と合うか堀本さんに確認する。
