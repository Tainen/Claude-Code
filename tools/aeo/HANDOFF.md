...
- No.004 は 2026-09-14 に上記方針で書き直し、Drive の旧 Doc は `_old_v3_自社比較あり_` にリネーム。**要確認**：No.008（部活動連携イベントの記事）と SKILL.md の「1回15万〜40万円（税抜）・追加料金なし」は HP 確定版の数字だが、「成果報酬」の説明と合うか堀本さんに確認する。
